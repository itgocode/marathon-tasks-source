...
Имя в вашем резюме это самый гланый заголовок страницы, поэтому используйте тег h1. Текст тега должен содержать ваше имя.
...
Добавь разметку для должности (заголовок третьего уровня) и периода работы (абзац).
...
Напиши разметку блока образования по аналогии с тем как вы делали разметку мест работы (8 - Work experience).
...
Оберните логические блоки (секции): биография, проекты, опыт работы и образование тегами `<section>`, как на изображении.
