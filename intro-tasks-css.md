...
Присвойте  селектору `ul`  свойство `paddig-left` и
значение `0`.
Добавьте к селектору `ul` еще одно свойство `list-style` и
значение `none`.
...
свойство `color` и значение `#ff6b08`
...
# 6 - Псевдокласс в качестве селектора.
