...
- В качестве селектора должно быть имена тегов `body` и `a`.
...
# 4 Применение нескольких CSS правил к одному селектору.

Присвойте  селектору `a`  свойство `color` и
значение `rgba(255, 255, 255, 128)`.
Добавьте к селектору `a` еще одно свойство `text-decoration` и
значение `none`.
...
- В качестве селектора должен быть тег `a`.
- После селектора должна быть открывающая и закрывающая фигурная скобка `{ }`.
...
Используйте имя класса `title-accent` в качестве селектора. Примените к этому селектору
свойства `color` и значением `#ff6b08`
...
# 5 - Псевдокласс в качестве селектора.

Для события `курсор над ссылкой`  задано новое CSS правило
со свойством `color` и значением `#fff`.
